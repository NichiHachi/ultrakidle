...
import { useIGCybergrindLeaderboard } from "../../hooks/useIGCybergrindLeaderboard";

export const IGCybergrindLeaderboard = () => {
  const { entries, loading } = useIGCybergrindLeaderboard();
